      ...
      <div className="relative z-20 flex h-full w-full items-end px-4 pb-12 pt-28 md:px-12 md:pb-20 md:pt-36">
        <div className="hero-synced-copy relative max-w-5xl">
          ...
          >
            <Button
              size="lg"
              className="hero-synced-primary-button w-full gap-2 border px-8 font-display text-lg text-primary-foreground transition-all duration-500 sm:w-auto"
            ...
            <Button
              variant="outline"
              size="lg"
              className="hero-synced-secondary-button w-full gap-2 border px-8 font-display text-lg transition-all duration-500 sm:w-auto"
